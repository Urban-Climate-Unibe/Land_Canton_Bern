...
temperature distributions, zonally meaned geospatial data as shown in
@burger2021 is used. These are cantonal land use classes as well as federal
geospatial data. All of the data is spatially averaged/meaned to obtain the
layers most effective as shown in @burger2021 as well as our own take:
generate three different geospatial layers per predictor class. The federal
and cantonal data is directly downloaded from the web into R and processed.
