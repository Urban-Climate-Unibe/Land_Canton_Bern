...
-- General burger better because more generalisable

-- Models perform as expected except xgboost

-- XGBoost overfitting?

-- Logger selection, at random, we have not looked at variable space
