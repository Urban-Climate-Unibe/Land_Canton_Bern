...
seconds if you do not use the tuning option.
...
6.  Plot shows the distribution of the temperature anomaly compared to a
    ...
    visualization of the bias and therefore of the systematic error.
...
We reduced the intervals by about 10% on both sides (and rounded it to a
even number), where possible. Please keep this in mind when exploring and
adjusting values.
...
meteoroolgical variables according to
