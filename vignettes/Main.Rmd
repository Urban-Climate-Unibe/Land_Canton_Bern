...
approximately 500,000 data points, as the calculation would otherwise take
several hours. Consequently, the knn model is not as well-trained as the
...
possible that these 10 loggers represent the worst ones, having the highest
RMSE and Bias and the lowest R². This would degrade our models. Of course,
this would be true for all models, including Burger's. But we think this
would make the validity of the models more honest. We recommend improving
the evaluation function by including more locations, perhaps using all 55
locations used in all years between 2019-2022. We believe this adjustment
would enhance our evaluation.
...
machine learning in future model selection.
...
the UHI during night-time only (22:00-06:00), while our model covers the
...
XGBoost of the training dataset become very low (not shown in the results)
