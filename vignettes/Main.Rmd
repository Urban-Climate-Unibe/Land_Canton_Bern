...
packages <- c("influxdbclient","ggplot2","tidyverse","lubridate","raster",
              ...
              "doParallel","terrainr","starsExtra")
...
knn_model <- KNN_Model(pp, combined_train)
...
source("../R/evaluation.R")
combined_test$fitted <- predict(lm_model, combined_test)
eval <- evaluate(combined_test,lm_model)
