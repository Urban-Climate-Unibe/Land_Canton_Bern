...
combined <- combined |>
    ...
    dplyr::select(all_of(c(tiff_names_short,meteoswiss_names)),temperature,hour,month,day) |> drop_na()
...
# meteo_pred <- c(0,1005,22.8,0.0,500,1.0,238,12,8,22)
# names(meteo_pred) <- c(meteoswiss_names[-1],"day","month","hour")

meteo_pred <- c(1000,1005,27.8,0.0,500,1.0,238,12,8,12)
names(meteo_pred) <- c(meteoswiss_names[-1],"day","month","hour")
