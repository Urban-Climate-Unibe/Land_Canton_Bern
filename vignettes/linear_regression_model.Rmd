...
multi.model <- multivariate.reg.model(Combined, c(1, 2, 3, 4, 5, 13, 14, 15))
...
pdf('../analysis/development_of.rsq.pdf',
    height = 5, width = 10)
p1
dev.off
...
multi.lm <- lm(temperature ~ tre200s0 + gre000z0 + ure200s0 + BUL_250 + 
                      dkl010z0 + prestas0 + VH_150 + AC_750 + rre150z0 + LV_03_E +
                      GA_25 + FO_1000 + TPI_500 + HuM + WA_150 + SLO_50 + LV_03_N + fkl010z0, 
                      data = Combined)
